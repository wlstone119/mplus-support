...
public class AutoGenerator {
     ...
     * 包列表 相关配置
     */
    private List<PackageConfig> packageInfoList;
    /**
     * 模板 相关配置
     */
    ...
    public void execute() {
        ...
        // 初始化配置
        if (null == config) {
            config = new ConfigBuilder(packageInfoList, dataSource, strategy, template, globalConfig);
    ...
    public List<PackageConfig> getPackageInfoList() {
        return packageInfoList;
    }

    public AutoGenerator setPackageInfoList(List<PackageConfig> packageInfoList) {
