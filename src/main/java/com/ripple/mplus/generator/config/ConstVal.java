...
public class ConstVal {
    ...
    public static final String FACADEIMPL = "FacadeImpl";
    ...
    public static final String FACADE_PATH = "facade_path";
    public static final String FACADEIMPL_PATH = "facadeimpl_path";
    ...
    public static final String TEMPLATE_FACADE = "/templates/facade.java";
    public static final String TEMPLATE_FACADEIMPL = "/templates/facadeImpl.java";
    ...
    public static final String SUPERD_FACADE_CLASS = "com.weidai.creditcenter.facade.api.base.BaseFacade";
    public static final String SUPERD_FACADEIMPL_CLASS = "com.weidai.creditcenter.provider.base.BaseFacadeImpl";
