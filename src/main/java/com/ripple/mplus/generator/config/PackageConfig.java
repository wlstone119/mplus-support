...
public class PackageConfig {
     ...
     * facade包名
     */
    private String facacde     = "facade.api";

    /**
     * facadeImpl包名
     */
    private String facacdeImpl = "provider";
...
//        }
    ...
    public String getFacacde() {
        return facacde;
    }

    public PackageConfig setFacacde(String facacde) {
        this.facacde = facacde;
        return this;
    }

    public String getFacacdeImpl() {
        return facacdeImpl;
    }

    public PackageConfig setFacacdeImpl(String facacdeImpl) {
        this.facacdeImpl = facacdeImpl;
        return this;
    }
