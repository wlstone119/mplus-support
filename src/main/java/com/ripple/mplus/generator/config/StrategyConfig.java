...
public class StrategyConfig {
    ...
    public StrategyConfig setSuperFacadeClass(String superFacadeClass) {
    ...
    public StrategyConfig setSuperFacadeImplClass(String superFacadeImplClass) {
    ...
    public StrategyConfig setFacadeClass(String facadeClass) {
    ...
    public StrategyConfig setFacadeImplClass(String facadeImplClass) {
