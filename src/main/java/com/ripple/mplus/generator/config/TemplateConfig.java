...
public class TemplateConfig {
    ...
    private String facadeImpl  = ConstVal.TEMPLATE_FACADEIMPL;
    ...
    public TemplateConfig setFacade(String facade) {
        this.facade = facade;
        return this;
    }
    ...
    public TemplateConfig setFacadeImpl(String facadeImpl) {
